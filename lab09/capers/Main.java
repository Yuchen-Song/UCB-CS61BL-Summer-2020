...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        Utils.writeContents(story, s + args[1] + "\n");
        System.out.print(s + args[1] + "\n");
    }
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        String path =CAPERS_FOLDER+"/dogs/";
        File dog_update = Utils.join(path, args[1]);
        Dog dog = Dog.fromFile(args[1]);
        dog.haveBirthday();
        Utils.writeObject(dog_update,dog);
    }
